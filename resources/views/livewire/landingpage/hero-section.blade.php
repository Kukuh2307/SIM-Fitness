<section id="home" class="w-screen min-h-screen font-semibold px-80 max-container padding-x">
    <div class="flex flex-col items-start justify-center min-h-screen overflow-x-hidden font-semibold max-container padding-x hero-animation">
