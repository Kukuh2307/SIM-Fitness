                ...
                <div class="container mx-auto mt-10">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="bg-white rounded-lg shadow-md">
                            <div class="p-6">
                                <h3 class="mb-4 text-lg font-semibold text-gray-800">Daftar Kelas</h3>
                                <div class="space-y-4">
                                    <!-- Class Item -->
                                    <label for="yoga" class="flex items-center p-4 border rounded-lg shadow-sm cursor-pointer transition duration-300 ring ring-transparent hover:ring-gray-300 focus:ring-gray-500">
                                        <input type="radio" id="yoga" name="class" class="hidden" value="Yoga">
                                        <img src="path-to-class-image" alt="Class Image" class="w-16 h-16 mr-4 rounded-lg">
                                        <div>
                                            <h4 class="text-sm font-semibold text-gray-800">Yoga</h4>
                                            <p class="text-xs text-gray-500">Instructor: John Doe</p>
                                            <p class="text-xs text-gray-500">Duration: 1 Hour</p>
                                            <p class="text-xs text-gray-500">Price: Rp 100.000</p>
                                        </div>
                                    </label>

                                    <!-- Repeat for other classes -->
                                    <label for="zumba" class="flex items-center p-4 border rounded-lg shadow-sm cursor-pointer transition duration-300 ring ring-transparent hover:ring-gray-300 focus:ring-gray-500">
                                        <input type="radio" id="zumba" name="class" class="hidden" value="Zumba">
                                        <img src="path-to-class-image" alt="Class Image" class="w-16 h-16 mr-4 rounded-lg">
                                        <div>
                                            <h4 class="text-sm font-semibold text-gray-800">Zumba</h4>
                                            <p class="text-xs text-gray-500">Instructor: Jane Smith</p>
                                            <p class="text-xs text-gray-500">Duration: 1 Hour</p>
                                            <p class="text-xs text-gray-500">Price: Rp 150.000</p>
                                        </div>
                                    </label>
