...
<div class="bg-gradient-to-tr from-red-600 to-slate-900">
    <div class="flex h-screen items-center justify-center">
        <div class="flex w-5/6 h-5/6 bg-white shadow-lg rounded-2xl overflow-hidden">
            <div class="relative flex items-center justify-around w-1/2 px-20 bg-cover bg-center" style="background-image: url('{{ asset('assets/img-6.jpg') }}');">
            ...
            <div class="flex items-center justify-center w-1/2 bg-white p-10">
                <form wire:submit.prevent="login" method="POST" class="bg-white w-full max-w-md">
                    @csrf
