<div class="py-4">
    ...
    <form wire:submit.prevent="{{ $btnUpdate ? 'update' : 'store' }}">
        ...
        <div class="flex items-start gap-4">
            ...
            <div class="flex flex-col w-full gap-3 md:w-1/2">
                <input type="text" name="spesialis" wire:model.lazy="spesialis" class="w-full p-2 text-black bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-red-600 focus:border-transparent" placeholder="Spesialis">
                ...
                @if($btnUpdate)
                    <input type="file" name="foto" wire:model="foto" class="w-full p-2 text-black bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-red-600 focus:border-transparent" value="{{ $foto }}">
