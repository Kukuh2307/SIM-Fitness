                    ...
                    <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2 lg:grid-cols-4 p-3">
                        ...
                        <div class="p-4 bg-white rounded-lg shadow-md">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold">{{$jumlah_kelas}}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 bg-white rounded-lg shadow-md">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold">{{$jumlah_instruktur}}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 bg-white rounded-lg shadow-md">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-md font-semibold text-gray-600">Total Income</p>
                                   
                                    <p class="text-sm font-bold">Rp {{number_format($sums,0,'.','.')}}</p>
                    ...
                    <div class="overflow-x-auto bg-white rounded-lg shadow-md">
                        <table class="w-full bg-white">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    <td class="px-4 py-2 border-t">{{$data->no_transaction}}</td>
                                    <td class="px-4 py-2 border-t">{{$data->member_name}}</td>
                                    <td class="px-4 py-2 border-t">Rp {{number_format($data->price,0, '.', '.')}}</td>
                                    <td class="px-4 py-2 border-t">{{$data->created_at}}</td>
                                    <td class="px-4 py-2 text-green-500 border-t">{{$data->status}}</td>
                                </tr>
                               @endforeach
