<div class=" h-screen">
    ...
    <div class="p-5 bg-slate-100">
       <p class="text-red-500 text-4xl font-bold">Gym Membership</p>
       <div class="lg:flex  membership-cards p-5 gap-5">
        {{-- 1 bulan --}}
            <form   
                ...
                @else
                    <button class="text-white bg-red-500 rounded-xl p-1 font-bold">
                        <a href="{{ route('register') }}" class="text-white bg-red-500 rounded-xl p-1 font-bold" >Beli Membership!</a>
                    </button>
                @endif
            </form>
        {{-- 6 bulan --}}
       ...
       <p class="text-4xl font-bold text-red-500">Hanya Mau Nge-Gym Sehari saja?</p>
       <div class="p-5">
        <form   
                action="{{route('createInvoice')}}" 
                method="post" 
                ...
                <input type="text" name="item_name" id="item_name" value="harian" class="hidden">
                {{-- price --}}
                <label for="price" class="text-white">
                    Rp <span class="font-bold">35.000</span>/hari
                </label>
                <hr>
                <div class="flex flex-col text-white mb-10 gap-2">
                    <div class="flex gap-2 items-center">
                        <i class="fi fi-ss-badge-check text-[30px] text-green-500"></i>
                    <p><span class="font-bold text-red-500 flex-1">Mulai Gym</span> hingga waktu tutup </p>
                    </div>
                ...
                @if (auth()->check())
                <button type="submit" class="text-white bg-red-500 rounded-xl p-1 font-bold">Beli Paket Harian!</button>
                @else
                    <button class="text-white bg-red-500 rounded-xl p-1 font-bold">
                        <a href="{{ route('register') }}" class="text-white bg-red-500 rounded-xl p-1 font-bold" >Beli Paket Harian!</a>
                    </button>
                @endif
            </form>
       </div>
