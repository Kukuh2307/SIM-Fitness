    ...
    @livewireStyles
        <form  class="p-5 mx-auto lg:px-20"   >
            ...
            <div class="flex gap-5">
                ...
                <div class="flex gap-2 items-center mb-4">
                    <input accept="image/png, image/jpeg, image/jpg" type="file" wire:model="Foto" name="foto" id="foto">
                </div>
               
            </div>
            <button wire:click.prevent="update" class="px-6 py-2 bg-red-500 text-white rounded-full">Save</button>
        </form>
    @livewireScripts
