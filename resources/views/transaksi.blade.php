        ...
        {{-- <div class="mx-auto max-w-7xl sm:px-6 lg:px-8"> --}}
            <div class="overflow-hidden bg-white p-6 rounded-lg shadow-lg">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="relative">
                        <input type="text" placeholder="Search" class="pl-8 pr-4 py-2 rounded-full border border-gray-300 focus:outline-none focus:border-red-400">
                ...
                <table class="min-w-full bg-white mb-8">
                    <thead>
                        <tr>
                            <th class="py-2 px-4 border-b border-gray-200 bg-gray-100 text-left text-sm font-semibold text-gray-700">Id Transaksi</th>
                            ...
                            <th class="py-2 px-4 border-b border-gray-200 bg-gray-100 text-right text-sm font-semibold text-gray-700">Status</th>
                            <th class="py-2 px-4 border-b border-gray-200 bg-gray-100 text-right text-sm font-semibold text-gray-700">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <!-- Example row -->
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b border-gray-200">10000</td>
                            <td class="py-2 px-4 border-b border-gray-200">00 00 0000</td>
                            <td class="py-2 px-4 border-b border-gray-200 text-right">Active</td>
